...
- **Gain low-level control**: GenSphere projects break workflows down to individual function calls and AI API calls. By doing so, you know exactly what's going on whenever running your application. 
...
in your project, be it as individual nodes in the execution graph or as [tools](https://platform.openai.com/docs/guides/function-calling)
for LLM API calls. You also create a separate .py file with pydantic models if you want to use openAI [structured output feature.](https://platform.openai.com/docs/guides/structured-outputs).
...
and anu associated functions or schemas .py files. An ID is generated, and your project becomes publicly accessible.
...
planning to allow for cycles, which will unlock full agentic systems using only GenSphere.
...
We welcome contributions! Please reach out at our [Discord server](https://discord.gg/DZFWMXJv).
